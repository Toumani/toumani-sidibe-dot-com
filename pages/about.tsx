...
const About = () => {
	const tools = ['kotlin', 'java', 'typescript', 'tailwindCSS', 'nextJS', 'react', 'ktor', 'spring']
	return (
		<>
			<Head>
				<title>About - Toumani Sidibe</title>
			</Head>

			<div>
				<h1 className="mt-8 mb-16 text-3xl text-white font-bold lg:text-5xl">
